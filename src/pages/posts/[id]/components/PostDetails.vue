<template>
  <BaseCard class="q-pa-lg">
    ...
    <div class="flex items-center">
      ...
      <div class="q-ml-md">
        <div>무명</div>
        <div class="text-grey-6">3 일전</div>
      </div>
    ...
    <div>
      Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aspernatur odit
      cum omnis eveniet eos quod quisquam, aperiam nesciunt facere eum,
      veritatis soluta corrupti non ad iusto harum laborum animi accusamus.
      <br />
      Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aspernatur odit
      cum omnis eveniet eos quod quisquam, aperiam nesciunt facere eum,
      veritatis soluta corrupti non ad iusto harum laborum animi accusamus.
